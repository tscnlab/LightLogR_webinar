...
[^1]: [Link to publication](https://doi.org/10.1371/journal.pbio.3001571){target="_blank"}

![Flowchart diagram of the *Case of light sensitivity* use case.](assets/advanced/flowcharts/adv_02.png)
...
2. Easily change the label format. Look at the help page of [`?strptime`](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/strptime){target="_blank"} for the available syntax.

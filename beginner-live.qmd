...
This document runs a self‑contained version of R **completely in your browser**[^2]. No setup or installation is required. You can execute the same [script](beginner.qmd) in a traditional R environment, but this browser‑based approach has several advantages:
